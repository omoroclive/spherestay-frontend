...
import { updatePassword, clearAuthError } from '@/store/slices/authSlice';
import {
  LockClosedIcon,
  EyeIcon,
  EyeSlashIcon,
...
const UpdatePassword = () => {
  ...
  const watchCurrentPassword = watch('passwordCurrent');
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
        {serverError && (
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl text-red-700">
            <p className="flex items-center">
              ...
              {serverError || 'An error occurred during password update. Please try again.'}
            </p>
          </div>
        )}
        ...
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="space-y-2">
            <label htmlFor="passwordCurrent" className="block text-sm font-semibold text-gray-700">
              Current Password
            </label>
            <div className="relative">
              ...
              {watchCurrentPassword && !errors.passwordCurrent && (
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`block w-full pl-10 pr-12 py-3 border rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-secondary-500 focus:border-transparent transition-all duration-200 ${
                  errors.password
                    ? 'border-red-300 bg-red-50'
                    : watchNewPassword && watchNewPassword.match(/^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])(?=.*[^A-Za-z0-9]).{8,}$/)
                    ? 'border-green-300 bg-green-50'
                    : 'border-gray-300 hover:border-gray-400'
                }`}
              />
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`block w-full pl-10 pr-12 py-3 border rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-secondary-500 focus:border-transparent transition-all duration-200 ${
                  errors.passwordConfirm
                    ? 'border-red-300 bg-red-50'
                    : watchConfirmPassword && watchConfirmPassword === watchNewPassword
                    ? 'border-green-300 bg-green-50'
                    : 'border-gray-300 hover:border-gray-400'
                }`}
              />
              ...
              {watchConfirmPassword && watchConfirmPassword === watchNewPassword && !errors.passwordConfirm && (
                <div className="absolute inset-y-0 right-10 pr-3 flex items-center">
                  <CheckCircleIcon className="h-5 w-5 text-green-500" />
                </div>
              )}
