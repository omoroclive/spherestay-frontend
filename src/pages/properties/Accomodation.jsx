      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-red-100 flex items-center justify-center">
        <div className="text-center p-8">
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md">
            ...
            <p className="text-gray-600 mb-6">Unable to load accommodations. Please try again.</p>
            <button
              onClick={() => refetch()}
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                Discover Premium Accommodations
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-3xl mx-auto">
                Luxury stays across beautiful destinations
              </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                {filteredAndSortedProperties.length} accommodations found
              </h2>
